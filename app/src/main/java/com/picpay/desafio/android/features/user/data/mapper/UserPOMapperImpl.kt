...
class UserPOMapperImpl @Inject constructor(): UserPOMapper{

    override fun userListToUserPOList(userList: List<User>): List<UserPO> {
   ...
   override fun userPOListToUserList(userPOList: List<UserPO>): List<User> {
